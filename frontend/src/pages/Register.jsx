...
export default function Register() {
  ...
  return (
    <div className="min-h-screen bg-[#0B0E14] text-[#E8EAED] flex items-center justify-center px-6 relative overflow-hidden py-10">
      <div
      ...
      <div className="relative w-full max-w-sm animate-[fadeUp_0.5s_ease-out]">
        <style>{`
          ...
          /* NAYA: browser autofill ka light background force-override,
             taake dark theme aur eye icon hamesha visible rahen */
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/40 text-sm">
            Start analyzing news in seconds
          </p>
        </div>

        <div className="border border-white/8 bg-white/2 rounded-2xl p-7">
          {success ? (
            <div className="bg-[#3ECF8E]/10 border border-[#3ECF8E]/25 text-[#3ECF8E] text-sm rounded-lg px-4 py-4 text-center">
              Account created! Redirecting to sign in...
            </div>
          ) : (
            // NAYA: form-level autoComplete="off" — kuch browsers isay
            // sirf form tag par honor karte hain, per-field ke sath milake.
            <form
